        ...
        let testimonialsLists = [
            {
                id : 1, 
                nama : 'Nusi' ,
                status : 'Mahasiswa Uym' ,
                testimoni : 'Syafiq Store memberikan layanan yang cepat dan efisien. Saya sangat puas dengan pengalaman Topup di sini!' ,
            }, 
            {
                id : 2, 
                nama : 'Aryo ' ,
                status : 'Mahasiswa Uym' ,
                testimoni : 'Belanja di Syafiq Store sangat praktis dan terjamin keamanannya.' ,
            },
            {
                id : 3, 
                nama : 'Mahendra' ,
                status : 'Mahasiswa Uym' ,
                testimoni : 'Saya selalu mendapatkan voucher game dengan harga terbaik di Syafiq Store.' ,
            },
            {
                id : 4, 
                nama : 'Hikam' ,
                status : 'Mahasiswa Uym' ,
                testimoni : 'Mantap top up di Syafiq Store sangat amanah.' ,
            },
